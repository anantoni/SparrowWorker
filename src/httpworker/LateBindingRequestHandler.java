        ...
        public void handle(
            ...
            if (request instanceof HttpEntityEnclosingRequest) {
                ...
                if (requestArgs.size() == 3) {
                        ...
                        String schedulerURL = requestArgs.get("scheduler-url");
                        String jobID = requestArgs.get("jod-id");
                        Thread probeResponseThread = new ProbeResponseThread(schedulerURL, jobID, taskExecutor);
